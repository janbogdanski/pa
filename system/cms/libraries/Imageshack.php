<?php
require_once("Imageshack/multipost.inc");
...
class Imageshack
{
     ...
     */
    function __construct($developer_key = '25EJMNUV0fb856a8693675ff415209f705ae40de', $cookie = null, $timeout = self::IMAGESHACK_API_TIMEOUT){
